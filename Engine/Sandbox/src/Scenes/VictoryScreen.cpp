...
Qbert::VictoryScreen::VictoryScreen() :Scene("VictoryScreen")
{
}

void Qbert::VictoryScreen::Initialize()
{
	...
	auto textComp = new peach::TextComponent("You Win!", fontBig);
	...
	auto id = ServiceLocator::GetSoundSystem()->AddSound("Resources/Sounds/Victory.wav");
